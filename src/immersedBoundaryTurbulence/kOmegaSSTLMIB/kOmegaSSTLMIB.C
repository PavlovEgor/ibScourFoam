...
tmp<volScalarField> kOmegaSSTLMIB<BasicTurbulenceModel>::F1
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIB<BasicTurbulenceModel>::Pk
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIB<BasicTurbulenceModel>::epsilonByk
(
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIB<BasicTurbulenceModel>::Fthetat
(
...
kOmegaSSTLMIB<BasicTurbulenceModel>::ReThetac() const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIB<BasicTurbulenceModel>::Flength
(
    const volScalarField::Internal& nu
) const
{
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIB<BasicTurbulenceModel>::ReThetat0
(
    const volScalarField::Internal& Us,
...
template<class BasicTurbulenceModel>
tmp<volScalarField::Internal> kOmegaSSTLMIB<BasicTurbulenceModel>::Fonset
(
...
template<class BasicTurbulenceModel>
kOmegaSSTLMIB<BasicTurbulenceModel>::kOmegaSSTLMIB
(
...
template<class BasicTurbulenceModel>
bool kOmegaSSTLMIB<BasicTurbulenceModel>::read()
{
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMIB<BasicTurbulenceModel>::correctReThetatGammaInt()
{
    // Local references
...
template<class BasicTurbulenceModel>
void kOmegaSSTLMIB<BasicTurbulenceModel>::correct()
{
    if (!this->turbulence_)
    {
        return;
